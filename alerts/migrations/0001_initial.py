# Generated by Django 3.2.7 on 2024-06-13 01:10
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=100,
                        verbose_name="Nome do modelo matemático",
                    ),
                ),
                (
                    "source_code",
                    models.TextField(
                        help_text="Variaveis disponiveis no momento: t = Temperatura rh = Umidade Relativa</h4>",
                        max_length=1000,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "lat_coordinate",
                    models.FloatField(null=True, verbose_name="Latitude"),
                ),
                (
                    "lon_coordinate",
                    models.FloatField(null=True, verbose_name="Longitude"),
                ),
                (
                    "description",
                    models.TextField(
                        ...
                        max_length=400,
                        null=True,
                        verbose_name="Descrição da estação",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        to="alerts.mathmodel",
                        verbose_name="Modelo matematico",
                    ),
                ),
                (
                    "requires",
                    models.ManyToManyField(blank=True, to="alerts.Requirement"),
                ),
                (
                    "sensor",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="alerts.sensor"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                null=True,
                to="alerts.Station",
                verbose_name="Estaçôes atreladas",
            ),
        ),
        migrations.CreateModel(
            name="Constant",
