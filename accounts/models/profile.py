...
from alerts.models import VerificationCode
...
class Profile(models.Model):
    ...
    role = models.CharField(max_length=100, verbose_name="Cargo de ofício",
                            help_text="Utilize como base seu cargo na instituição citada.")
    phone = models.CharField(unique=True, max_length=11, verbose_name="Telefone fixo ou celular",
    ...
    def is_phone_number_verified(self):
        return VerificationCode.objects.filter(user=self.user, user__profile__phone=self.phone,
