...
class MathModels(models.Model):
	...
	math_model_name = models.CharField('Nome do modelo matemático', max_length=100, blank=False,
	...
	var1_kind = models.CharField('Dado da variável 1', max_length=20,
								 help_text='Insira que dado será utilizado na variável 1 (ex: temperatura mínima, umidade, molhamento foliar',
								 blank=False)

	var2 = models.CharField('Variável 2', max_length=20, help_text='Insira a variável 2 que será utlizada', blank=True)
	var2_kind = models.CharField('Dado da variável 2', max_length=20,
								 help_text='Insira que dado será utilizado na variável 2 (ex: temperatura mínima, umidade, molhamento foliar',
								 blank=True)

	var3 = models.CharField('Variável 3', max_length=20, help_text='Insira a variável 3 que será utlizada', blank=True)
	var3_kind = models.CharField('Dado da variável 3', max_length=20,
								 help_text='Insira que dado será utilizado na variável 2 (ex: temperatura mínima, umidade, molhamento foliar',
								 blank=True)

	# TODO: para variáveis e constantes adicionar campos no formulário dinamicamente

	equation = models.CharField('Equação', max_length=20,
								help_text='Insira a equação. Para soma utilize +, para subtração utilize menos, para divisão utilize /, para multiplicação utilize *',
								blank=True)
